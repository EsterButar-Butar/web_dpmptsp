                    ...
                    <tbody class="text-sm divide-y divide-slate-100">
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border shadow-sm {{ $statusLq['color'] }}">
                                    {{ $statusLq['action'] }}
                                </span>
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border shadow-sm {{ $statusSs['color'] }}">
                                    {{ $statusSs['action'] }}
                                </span>
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border shadow-sm {{ $statusTipologi['color'] }}">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border shadow-sm {{ $statusKlassen['color'] }}">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden sticky top-6">
            ...
            <div class="p-5 space-y-5">
                @forelse(array_slice($activityLogs, 0, 5) as $log)
                    @php
                    ...
                    <div class="flex items-start gap-4 group cursor-default">
                        <div class="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 {{ $iconClass }} transition-transform group-hover:scale-110">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-slate-400 mt-1.5">{{ $log['time'] }} &bull; {{ $log['module'] }}</p>
                        </div>
                    </div>
                @empty
