...
<body>
    ...
    <div class="title-block">
        <h3>Laporan Hasil Analisis Location Quotient (LQ)</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-right" style="width: 8%;">Nilai LQ</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="8" class="text-center">Tidak ada data analisis LQ.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
