...
<div>
    ...
    <div class="op-card">
        <div class="op-card-header">
            ...
            <form action="{{ $editItem ? route('operator.ss.update', $editItem['id']) : route('operator.ss.hitung') }}" method="POST" x-data="{ 
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                ...
                                <td class="px-4 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('operator.ss.destroy', $data['id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');" class="inline-block">
                                            @csrf
                                            @method('DELETE')
