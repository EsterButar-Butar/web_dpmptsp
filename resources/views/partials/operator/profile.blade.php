        ...
        <div class="p-6 md:p-8">
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div x-data="{ photoPreview: null }" class="flex flex-col items-center space-y-4">
                    ...
                    <div class="w-32 h-32 rounded-full bg-blue-100 overflow-hidden border-4 border-white shadow-lg relative group" @click="$refs.photo.click()">
                    ...
                    <button type="button" @click="$refs.photo.click()" class="px-4 py-2 bg-blue-50 text-blue-600 rounded-lg text-sm font-semibold hover:bg-blue-100 transition-colors">
                        Ubah Foto
                    </button>
                ...
                <div class="flex-1 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="{{ Auth::user()?->name ?? 'Siti' }}" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none" placeholder="Masukkan nama">
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-slate-700">Email</label>
                            <input type="email" name="email" value="{{ Auth::user()?->email ?? 'siti@operator.com' }}" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none" placeholder="Masukkan email">
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="phone" value="081234567890" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none" placeholder="Masukkan nomor">
                        </div>
                    </div>
                    ...
                    <div class="pt-4 flex justify-end gap-3 border-t border-slate-100">
                        ...
                        <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm shadow-blue-200 transition-all">Simpan Perubahan</button>
                    </div>
                </div>
            </div>
        </div>
